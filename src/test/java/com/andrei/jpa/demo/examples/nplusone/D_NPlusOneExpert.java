...
/**
 * Example showcase 4 for the n + 1 problem.
 *
...
public class D_NPlusOneExpert {
	...
	@Test
	public void nPlusOneExpertUsecase() {

		List<CarProject> audiProjects = carProjectRepository.findByCarBrandFetchModelsQueryHints(CarBrand.AUDI);
